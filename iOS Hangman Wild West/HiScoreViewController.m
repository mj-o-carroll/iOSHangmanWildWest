...
-(NSArray *)content
{
    if (!_content)
    {
        ...
        _content = [[NSMutableArray alloc] initWithContentsOfFile:plistLocation];
    }
...
- (void)viewDidLoad
{
    ...
    // for score tableview background, looked like puke!
    //_hiScoreBackground.backgroundColor  = [UIColor colorWithPatternImage:[UIImage imageNamed:@"scores_bkg.png"]];
}
